      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 items-center">
        ...
        <div className={`lg:col-span-5 ${index % 2 === 1 ? 'lg:order-1' : 'lg:order-2'} flex flex-col justify-center`}>
            <div className="space-y-8">
                ...
                <div className="pt-4">
                    <button className="inline-flex items-center gap-3 text-sm font-bold uppercase tracking-widest text-primary border-b border-transparent hover:border-primary pb-1 transition-all group/btn">
                        View Case Study
